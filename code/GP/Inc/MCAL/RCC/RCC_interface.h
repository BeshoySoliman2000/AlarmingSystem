...
void MRCC_voidSetBusesPrescalars(u8 A_u8AHBPrescaler, u8 A_u8APB1Prescaler, u8 A_u8APB2Prescaler);
...
/* A_u8Bus: APB1 - APB2 */
/* A_u8CLKSignal: Enable - Disable */
void 	MRCC_voidPerClock_State(u8 A_u8Bus,u8 A_u8Peripheral,u8 A_u8CLKSignal);
